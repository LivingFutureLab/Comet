...
__all__ = ["TimersPersistentState", "Timers", "Timer", "TimerBase", "get_timers"]
...
class TimersPersistentState:
    timers: Optional[Timers] = None

    @classmethod
    def init(cls, log_level: int, log_option: str):
        timers = Timers(log_level, log_option)
        TimersPersistentState.set(timers)
...
def get_timers() -> Timers:
    return TimersPersistentState.get()
